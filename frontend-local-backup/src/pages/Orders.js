...
function Orders() {
  ...
  const handlePaymentSubmit = async (e) => {
    ...
    try {
      ...
      if (err.message.includes('Insufficient stock')) {
        setPaymentError('Some items in your cart are out of stock. Please update your cart and try again.');
      } else {
  ...
  const handlePlaceOrder = async () => {
    ...
    try {
      ...
      if (err.message.includes('Insufficient stock')) {
        setError('Some items in your cart are out of stock. Please update your cart and try again.');
      } else {
